...
<body>
    ...
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/checklist_excluir.php?id=" + id;
            }
        }
    </script>
    ...
    <div class="container -my5">
        ...
        <hr>
        <table class="table display table-hover  table-condensed tabchecklist">
            ...
            <tbody>
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>
                    <a class='btn btn-info btn-sm' href='/gop/checklist_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
