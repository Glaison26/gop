...
<script language="Javascript">
        function confirmacao_ferramentas(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/preventivas/preventivas_ferramentas_excluir.php?id=" + id;
            }
        }
    </script>
...
<script type="text/javascript">
        ...
        $(document).on('submit', '#frmadd_ferramenta', function(e) {
            ...
            if (c_descricao != '') {
                ...
                $.ajax({
                    url: "preventivas_ferramentas_inclusao.php",
                    type: "post",
                    data: {
    ...
    <div class="container-fluid">
        ...
        <table class="table display table-hover  table-condensed tabferramentas">
            ...
            <tbody>
                ...
                $c_sql = "SELECT preventivas_ferramentas.id, ferramentas.descricao, ferramentas.patrimonio, marcas.descricao AS marca FROM preventivas_ferramentas
                    JOIN ferramentas ON preventivas_ferramentas.id_ferramenta=ferramentas.id
                    JOIN marcas ON ferramentas.id_marca = marcas.id
                    WHERE preventivas_ferramentas.id_preventiva='$i_id'
