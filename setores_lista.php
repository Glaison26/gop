...
<head>
    ...
    <title>Gop - Lista de Setores</title>
...
<body>
    ...
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/setores_excluir.php?id=" + id;
            }
        }
    </script>
    ...
    <div class="container -my5">
        ...
        <a class="btn btn-success btn-sm" href="/gop/setores_novo.php"><span class="glyphicon glyphicon-plus"></span> Incluir</a>
        <a class="btn btn-info btn-sm" href=""><span class="glyphicon glyphicon-print"></span> Imprimir</a>
        <a class="btn btn-secondary btn-sm" href="/gop/menu.php"><span class="glyphicon glyphicon-off"></span> Voltar</a>

        <hr>
        <table class="table display table-hover  table-condensed tabsetores">
            ...
            <tbody>
                ...
                $c_sql = "SELECT setores.id, setores.descricao, setores.responsavel, setores.fone1, setores.fone2 FROM setores ORDER BY setores.descricao";
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>$c_linha[fone2]</td>
                    <td>
                    <a class='btn btn-info btn-sm' href='/gop/setores_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
