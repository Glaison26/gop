...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $c_sql = "Insert into ocorrencias (descricao)" .
            "Value ('$c_descricao')";
        ...
        header('location: /gop/ocorrencias_lista.php');
    } while (false);
}
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="offset-sm-3 col-sm-3">
                    ...
                    <a class='btn btn-danger' href='/gop/ocorrencias_lista.php'><span class='glyphicon glyphicon-remove'></span> Cancelar</a>
                </div>
