...
$c_sql_espaco = "SELECT preventivas.id, preventivas.tipo, preventivas.periodicidade_geracao, preventivas.calibracao, preventivas.id_espaco, espacos.descricao as espaco,
