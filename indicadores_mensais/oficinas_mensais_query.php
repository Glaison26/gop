...
if ((isset($_POST["btnpesquisa"])) && ($_SERVER['REQUEST_METHOD'] == 'POST')) {
    ...
    //
    $c_sql = "SELECT extract(month FROM ordens.data_geracao) AS mes, ordens.id_oficina, oficinas.descricao, COUNT(ordens.id_oficina) total
            FROM ordens 
...
<body>
    <div class="panel panel-primary class">
        <div class="panel-heading text-center">
            ...
            <h5>Opções de Relatório para comparativos de Oficinas Mensais<h5>
        </div>
    </div>
