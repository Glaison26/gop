...
$_SESSION['titulo_rel'] = "Relatório Comparativo Mensal de Setores da Manutenção por Período";
$_SESSION['titulo_graf'] = "Gráfico Comparativo Mensal de Setores da Manutenção por Período";
...
if ((isset($_POST["btnpesquisa"])) && ($_SERVER['REQUEST_METHOD'] == 'POST')) {
    ...
    //
    $c_sql = "SELECT extract(month FROM ordens.data_geracao) AS mes, ordens.id_setor, setores.descricao, COUNT(ordens.id_setor) total
            FROM ordens 
            JOIN setores ON ordens.id_setor=setores.id
            WHERE $c_where
            GROUP BY extract(month FROM ordens.data_geracao), ordens.id_setor ORDER BY mes";
...
<body>
    <div class="panel panel-primary class">
        <div class="panel-heading text-center">
            ...
            <h5>Opções para Relatório Mensais para Setores<h5>
        </div>
    </div>
