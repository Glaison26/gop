...
$_SESSION['titulo_rel'] = "Relatório Comparativo Mensal de Solicitantes da Manutenção por Período";
$_SESSION['titulo_graf'] = "Gráfico Comparativo Mensal de Solicitantes da Manutenção por Período";
//
...
if ((isset($_POST["btnpesquisa"])) && ($_SERVER['REQUEST_METHOD'] == 'POST')) {
    ...
    //
    $c_sql = "SELECT extract(month FROM ordens.data_geracao) AS mes, ordens.id_solicitante, usuarios.nome, COUNT(ordens.id_solicitante) total
            FROM ordens 
            JOIN usuarios ON ordens.id_solicitante=usuarios.id
            WHERE $c_where
            GROUP BY extract(month FROM ordens.data_geracao), ordens.id_solicitante ORDER BY mes";
...
<body>
    <div class="panel panel-primary class">
        <div class="panel-heading text-center">
            ...
            <h5>Opções de Relatório para comparativos de Solicitantes Mensais<h5>
        </div>
    </div>
