...
<head>
    ...
    <title>Detalhe de Ocorrências</title>
...
<body>
    <div class="panel panel-primary class">
        <div class="panel-heading text-center">
            ...
            <h5>Detalhe de Ocorrências por Executores<h5>
        </div>
    </div>
    <div class="content">
        <div class="container -my5">
            <div class="container content-box">
                <form action="relatorio_detalhe.php" target="_blank" method="post">
                    ...
                    <div class='alert alert-info' role='alert'>
                        ...
                        <h5><?php echo "Informe o Executor e o periodo para visualizar o relatório" ?> </h5>
                    </div>
