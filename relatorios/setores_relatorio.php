...
<body>
    <div class="container">
        <h2 class="text-center">Relatório de Manutenção por Setores no Período</h2><br>
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                while ($registro = $result_grafico->fetch_assoc()) {
                    $c_setor = $registro['descricao'];
                    $c_qtd =  $registro['total'];
                ?>['<?php echo $c_setor ?>', <?php echo $c_qtd ?>],
                <?php } ?>
            ]);
    ...
    <div style="padding-left:400px;">
        <h3 class="text-center">Relatório de Manutenção por Setores no Período</h3>
