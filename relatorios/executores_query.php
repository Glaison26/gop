...
if ((isset($_POST["btnpesquisa"])) && ($_SERVER['REQUEST_METHOD'] == 'POST')) {
    ...
    $c_sql = "SELECT ordens_executores.id_executor, executores.nome, SUM(ordens_executores.tempo_horas) as total_horas,
   ...
   $result = $conection->query($c_sql);
    ...
    while ($c_linha = $result->fetch_assoc()) {
        ...
        $c_sql_ins = "insert into temp_horas (horas, minutos, executor) values ('$horas','$minutos','$c_executor')";
