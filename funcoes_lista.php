...
<body>
    ...
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/funcoes_excluir.php?id=" + id;
            }
        }
    </script>
    ...
    <div class="panel panel-light" style="background-color: #e3f2fd;">
        <div class="panel-heading text-center">
            <h2>Lista de Cargos e Funções</h2>
        </div>
    </div>
    <div class="container -my5">
        <br>
        <a class="btn btn-success btn-sm" href="/gop/funcoes_novo.php"><span class="glyphicon glyphicon-plus"></span> Incluir</a>
        <a class="btn btn-info btn-sm" href=""><span class="glyphicon glyphicon-print"></span> Imprimir</a>
        <a class="btn btn-secondary btn-sm" href="/gop/menu.php"><span class="glyphicon glyphicon-off"></span> Voltar</a>

        <hr>
        <table class="table display table-hover  table-condensed tabfuncoes">
            ...
            <tbody>
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    $c_custo = mask($c_linha['valorhora'], 'R$#########');
                    echo "
                    <tr>
                    <td>$c_linha[id]</td>
                    ...
                    <td>$c_custo</td>
                    <td>
                    <a class='btn btn-info btn-sm' href='/gop/funcoes_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
