...
<head>
    ...
    <title>Editar dados do Executor</title>
    <script>
        ...
        <div class="container content-box">
            ...
            <form method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <input type="tel" maxlength="20" onkeyup="handlePhone(event)" id="fone1" class="form-control" name="fone1" value="<?php echo $c_fone1; ?>" required>
                    </div>
