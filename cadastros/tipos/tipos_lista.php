...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.cadastros_tipos FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['cadastros_tipos'] == 'N') {
...
<body>
    ...
    <div class="container-fluid">
        ...
        <hr>
        <table class="table table-bordered table-striped tabtipos">
            <thead class="thead">
                <tr>
                    <th scope="col">#</th>
