...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.almoxarifado_unidadesmedidas FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['almoxarifado_unidadesmedidas'] == 'N') {
...
<body>
    ...
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/cadastros/unidades/unidades_excluir.php?id=" + id;
            }
        }
    </script>
    ...
    <script type="text/javascript">
        $(document).on('submit', '#frmadd', function(e) {
            ...
            var c_abreviatura = $('#add_abreviaturaField').val();

            if (c_descricao != '') {

                $.ajax({
                    url: "unidades_novo.php",
                    type: "post",
                    data: {
                        c_descricao: c_descricao,
                        c_abreviatura: c_abreviatura
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.editbtn').on('click', function() {
                ...
                $('#up_abreviaturaField').val(data[2]);
            });
        });
    </script>
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', '#frmup', function(e) {
            ...
            var c_abreviatura = $('#up_abreviaturaField').val();

            if (c_descricao != '') {

                $.ajax({
                    url: "unidades_editar.php",
                    type: "post",
                    data: {
                        c_id: c_id,
                        c_descricao: c_descricao,
    ...
    <div class="panel panel-primary class">
        <div class="panel-heading text-center">
            ...
            <h5>Lista de Unidades e Medidas<h5>
        </div>
    </div>
    <br>
    <div class="container-fluid">

        <button type="button" title="Inclusão de Nova Unidade" class="btn btn-success btn-sm" data-toggle="modal" data-target="#novoModal"><span class="glyphicon glyphicon-plus"></span>
            Incluir
        </button>
        <a class="btn btn-secondary btn-sm" href="/gop/menu.php"><span class="glyphicon glyphicon-off"></span> Voltar</a>

        <hr>
        <table class="table table-bordered table-striped tabunidades">
            <thead class="thead">
                <tr>
            ...
            <tbody>
                ...
                $c_sql = "SELECT unidades.id, unidades.descricao, unidades.abreviatura FROM unidades ORDER BY unidades.descricao";
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>$c_linha[abreviatura]</td>
                    <td>
                    <button type='button' class='btn btn-secondary btn-sm editbtn' data-toggle='modal' title='Editar Unidades de Medida'><span class='glyphicon glyphicon-pencil'></span> Editar</button>
        ...
        <div class="modal-dialog modal-dialog-centered" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Inclusão de nova unidade</h4>
                </div>
