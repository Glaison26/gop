...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.cadastros_ferramentas FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['cadastros_ferramentas'] == 'N') {
...
<body>
    ...
    <div class="container-fluid">
        ...
        <hr>
        <table class="table table-bordered table-striped tabferramentas">
            <thead class="thead">
                <tr>
