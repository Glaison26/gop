...
<head>
    ...
    <title>GOP - Cadastro de novo POP</title>
            ...
            <form method="post">
                        ...
                        <div style="padding-top:15px;padding-left:20px;">
                            <div class="row mb-3">
                                <div class="form-check" class="col-sm-6">
                                    ...
                                    <input type="radio" name="tipopop" id="tipo1" value="1" checked>
                ...
                <div class="row mb-3">
                    <div class="offset-sm-0 col-sm-3">
                        ...
                        <a class='btn btn-danger' href='/gop/cadastros/pop/pops_lista.php'><span class='glyphicon glyphicon-remove'></span> Cancelar</a>
                    </div>
