...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['cadastros_cargosfuncoes'] == 'N') {
...
<body>
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/cadastros/funcoes/funcoes_excluir.php?id=" + id;
            }
        }
    </script>
    ...
    <!-- script para máscar financeira -->
    <script>
        $(function() {
            $("#add_valorField").maskMoney();
        });
    </script>
    ...
    <script type="text/javascript">
        $(document).on('submit', '#frmadd', function(e) {
            ...
            var c_valor = $('#add_valorField').val();

            if (c_descricao != '') {

                $.ajax({
                    url: "funcoes_novo.php",
                    type: "post",
                    data: {
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', '#frmup', function(e) {
            ...
            c_valor = c_valor.replace(/[^0-9,]*/g, '').replace(',', '.');

            if (c_descricao != '') {

                $.ajax({
                    url: "funcoes_editar.php",
                    type: "post",
                    data: {
                        c_id: c_id,
                        c_descricao: c_descricao,
