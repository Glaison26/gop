...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.cadastros_prestadores FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['cadastros_prestadores'] == 'N') {
