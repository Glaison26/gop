...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $c_sql_insert = "INSERT INTO prestadores (nome,id_tipo,razao_social,cnpj,contato,telefone1,telefone2,
        endereco,bairro,cidade,uf,cep,email,site,observacao,ativa,valor_contrato,valor_visita)
        VALUES ('$c_nome','$c_grupo','$c_razao','$c_cnpj','$c_contato','$c_fone1','$c_fone2',
        '$c_endereco','$c_bairro','$c_cidade','$c_estado','$c_cep','$c_email','$c_url','$c_obs','$c_status',
