...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.cadastros_setores FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['cadastros_setores'] == 'N') {
...
<body>
    ...
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/cadastros/setores/setores_excluir.php?id=" + id;
            }
        }
    </script>
