...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.cadastro_centrosdecusto FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['cadastro_centrosdecusto'] == 'N') {
