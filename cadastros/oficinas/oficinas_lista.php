...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.cadastros_oficinas FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['cadastros_oficinas'] == 'N') {
...
<body>
    ...
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/cadastros/oficinas/oficinas_excluir.php?id=" + id;
            }
        }
    </script>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Editar Oficina</h4>
                </div>
                <div class="modal-body">
                    <div class='alert alert-warning' role='alert'>
                        <h5>Campos com (*) são obrigatórios</h5>
