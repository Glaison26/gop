        ...
        <div class="container content-box">
            ...
            <form method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-1">
                        <input type="text" maxlength="5" id="medida" class="form-control col-xs-12" name="medida" value="<?php echo $c_medida; ?>">
                    </div>
                </div>
                <?php
                if (!empty($msg_gravou)) {
                ...
                <div class="row mb-3">
                    <div class="offset-sm-0 col-sm-3">
                        ...
                        <a class='btn btn-danger' href='/gop/cadastros/espacos/espacos_lista.php'><span class='glyphicon glyphicon-remove'></span> Cancelar</a>
                    </div>
