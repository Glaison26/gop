...
$c_sql_conta = "select count(*) nregistros from recursos where id_fornecedor=$c_id";
...
if ($registro['nregistros'] == 0) {
    ...
    echo "<div class='container-fluid'>
     <a class='btn btn-primary' href='/gop/cadastros/fornecedores/fornecedores_lista.php'><span class='glyphicon glyphicon-off'></span> Voltar a Lista</a>
    </div>";
}
