...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.cadastros_fornecedores FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['cadastros_fornecedores'] == 'N') {
...
<body>
    ...
    <div class="container-fluid">
        ...
        <hr>
        <table class="table table-bordered table-striped tabfornecedores">
            <thead class="thead">
                <tr>
