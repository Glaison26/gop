...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {  // metodo get para carregar dados no formulário
    ...
    if (!$registro) {
        header('location: /gop/almoxarifado/cotacao_materiais_fornecedores.php');
        exit;
    }
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="offset-sm-0 col-sm-3">
                    ...
                    <a class='btn btn-danger' href='/gop/almoxarifado/cotacao_materiais_fornecedores.php'><span class='glyphicon glyphicon-remove'></span> Cancelar</a>
                </div>
