...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.almoxarifado_cotacoes FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['almoxarifado_cotacoes'] == 'N') {
