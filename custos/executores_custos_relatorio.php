...
<body>
    <div class="container">
        <h2 class="text-center">Relatório de Custos por Executor</h2><br>
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                while ($registro = $result_grafico->fetch_assoc()) {
                    $c_executor = $registro['descricao'];
                    $c_valor_total =  $registro['valor_total'];
                ?>['<?php echo $c_executor ?>', <?php echo $c_valor_total ?>],
                <?php } ?>
            ]);
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                ?>['<?php echo $c_executor ?>', <?php echo $c_valor_material ?>],
                <?php } ?>
            ]);
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                ?>['<?php echo $c_executor ?>', <?php echo $c_valor_servico ?>],
                <?php } ?>
            ]);
