...
<body>
    <div class="container">
        <h2 class="text-center">Relatório de Custos por Centro de Custo</h2><br>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                ?>['<?php echo $c_centrodecusto ?>', <?php echo $c_valor_total ?>],
                <?php } ?>
            ]);
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                ?>['<?php echo $c_centrodecusto ?>', <?php echo $c_valor_material ?>],
                <?php } ?>
            ]);
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                ?>['<?php echo $c_centrodecusto ?>', <?php echo $c_valor_servico ?>],
                <?php } ?>
            ]);
    ...
    <div style="padding-left:300px;">
        <h5 class="text-left">Gráfico Custos por Centro de Custo no Período - Valor Total</h5>
        <div id="chart1" style="width: 400px; height: 300px;"></div>
    </div>

    <div style="padding-left:300px;">
        <h5 class="text-left">Gráfico Custos por Centro de Custo no Período - Valor Material</h5>
        <div id="chart2" style="width: 400px; height: 300px;"></div>
    </div>

    <div style="padding-left:300px;">
        <h5 class="text-left">Gráfico Custos por Centro de Custo no Período - Valor Serviço</h5>
