...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $c_sql = "Insert into oficinas (descricao)" .
            "Value ('$c_descricao')";
...
<body>
    <div class="panel panel-light" style="background-color: #e3f2fd;">
        <div class="panel-heading text-center">
            <h2>Novo registro de Oficina</h2>
        </div>
    </div>
    <br>
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="offset-sm-3 col-sm-3">
                    ...
                    <a class='btn btn-danger' href='/gop/oficinas_lista.php'><span class='glyphicon glyphicon-remove'></span> Cancelar</a>
                </div>
