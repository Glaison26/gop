...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $c_sql = "Insert into grupos (descricao)" .
            "Value ('$c_descricao')";
        ...
        header('location: /gop/grupos_lista.php');
    } while (false);
}
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="offset-sm-3 col-sm-3">
                    ...
                    <a class='btn btn-danger' href='/gop/grupos_lista.php'><span class='glyphicon glyphicon-remove'></span> Cancelar</a>
                </div>
