...
$c_sql_acesso = "select usuarios.tipo, perfil_usuarios.servicos_plano_acao FROM usuarios
...
if ($registro_acesso['tipo'] == 'Operador' && $registro_acesso['servicos_plano_acao'] == 'N') {
