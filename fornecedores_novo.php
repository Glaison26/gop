...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $c_sql = "Insert into fornecedores (descricao, razaosocial, contato, fone1, fone2, endereco," .
            "bairro, cep, estado, email, cidade,  tipo, cnpj_cpf, insc_estad, insc_munic, site, obs, id_grupo  )" .
            "Value ('$c_descricao', '$c_razao', '$c_contato', '$c_fone1', '$c_fone2', '$c_endereco', '$c_bairro'," .
            " '$c_cep', '$c_estado', '$c_email' ,'$c_cidade', '$c_tipo', '$c_cnpj_cpf', '$c_insc_estad', '$c_insc_munic', '$c_url', '$c_obs', '$i_grupo')";
...
<div class="panel panel-light" style="background-color: #e3f2fd;">
    <div class="panel-heading text-center">
        <h2>Novo registro de Fornecedor</h2>
    </div>
</div>
<br>
