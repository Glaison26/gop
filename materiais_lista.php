...
<body>
    ...
    <div class="container -my5">
        ...
        <hr>
        <table class="table display table-hover  table-condensed tabmateriais">
            ...
            <tbody>
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>$c_custo</td>
                    <td>
                    <a class='btn btn-info btn-sm' href='/gop/materiais_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
