...
$_SESSION['titulo_rel'] = "Relatório Comparativo de Custos Mensais de Setores da Manutenção por Período";
$_SESSION['titulo_graf'] = "Gráfico Comparativo de Custos Mensais de Setores da Manutenção por Período";
...
if ((isset($_POST["btnpesquisa"])) && ($_SERVER['REQUEST_METHOD'] == 'POST')) {
    ...
    //
    $c_sql = "SELECT extract(month FROM ordens.data_geracao) AS mes, ordens.id_setor, setores.descricao,
...
<body>
    <div class="panel panel-primary class">
        <div class="panel-heading text-center">
            ...
            <h5>Opções para Relatório de Custos Mensais para Setores<h5>
        </div>
    </div>
