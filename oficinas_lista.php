...
<head>
    ...
    <title>Gop - Lista de Oficinas</title>
...
<body>
    ...
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/gop/oficinas_excluir.php?id=" + id;
            }
        }
    </script>
    ...
    <div class="container -my5">
        ...
        <a class="btn btn-success btn-sm" href="/gop/oficinas_novo.php"><span class="glyphicon glyphicon-plus"></span> Incluir</a>
        <a class="btn btn-info btn-sm" href=""><span class="glyphicon glyphicon-print"></span> Imprimir</a>
        <a class="btn btn-secondary btn-sm" href="/gop/menu.php"><span class="glyphicon glyphicon-off"></span> Voltar</a>

        <hr>
        <table class="table display table-hover  table-condensed taboficinas">
            ...
            <tbody>
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>
                    <a class='btn btn-info btn-sm' href='/gop/oficinas_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
