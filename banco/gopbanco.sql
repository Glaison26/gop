...
INSERT INTO `checklist` (`id`, `descricao`, `descritivo`) VALUES
	(1, 'Instalação de Memória SSD', _binary 0x2d2043686176652064652046656e64610d0a2d2050656e20447269766520436f6d2053697374656d61204f7065726163696f6e616c0d0a2d20446973636f2065787465726e6f2070617261206261636b7570);
...
INSERT INTO `espacos` (`id`, `descricao`, `tipo`, `medida`, `endereco`, `bairro`, `cidade`, `cep`, `responsavel`, `email`, `fone1`, `fone2`) VALUES
	(1, 'Meio Ambiente', 'Instalação', '30', 'Rua da Itendencia 316', 'Centro', 'Sabará', '34505480', 'Prefeitura', 'SIM', '', ''),
...
INSERT INTO `fornecedores` (`id`, `id_grupo`, `descricao`, `razaosocial`, `cnpj_cpf`, `insc_estad`, `insc_munic`, `tipo`, `endereco`, `bairro`, `cep`, `cidade`, `estado`, `fone1`, `fone2`, `email`, `site`, `contato`, `obs`) VALUES
	...
	(2, 1, 'Metodo', 'Método Informática SA', '22.998.344/0001-99', '', '', 'Juridica', '', '', '', 'Belo Horizonte', 'MG', '(31)3454-3333', '(31)2453-3332', '', '', 'Guilherme', _binary 0x7465737465);
...
-- Copiando dados para a tabela gop.funcoes: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela gop.oficinas: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela gop.pops: ~1 rows (aproximadamente)
...
INSERT INTO `recursos` (`id`, `id_espacofisico`, `id_fabricante`, `id_fornecedor`, `id_grupo`, `id_centrodecusto`, `id_oficina`, `id_setor`, `id_marca`, `descricao`, `patrimonio`, `modelo`, `numeroserie`, `estado`, `notafiscal`, `datacadastro`, `datagarantia`, `valoraquisicao`, `valordepreciado`, `ultimapreventiva`, `ultimamanutencao`, `dataaquisicao`, `ativo`, `motivoinativo`, `reganvisa`, `obs`) VALUES
	(1, 1, 2, 2, 7, 2, 1, 1, 6, 'computador', '1222', 'asdA', '3423234', 'Ótimo', '234', '2023-02-08', '2023-02-08', 3000, 23, '2023-02-08', '2023-02-08', '2023-02-08', 'S', 'DDD', '3333', _binary 0x746573746520636f6d20656469c3a7c3a36f),
...
-- Copiando dados para a tabela gop.setores: ~1 rows (aproximadamente)
