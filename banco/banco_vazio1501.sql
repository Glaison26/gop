...
-- Copiando dados para a tabela gop.centrodecusto: ~0 rows (aproximadamente)
...
INSERT INTO `configuracoes` (`id`, `empresa`, `cnpj`, `responsavel`, `fone1`, `fone2`, `url`, `email_manutencao`, `emailcc_manutencao`, `emailco_manutencao`, `email_envio`, `email_host`, `senha_email`, `porta_smtp`) VALUES
	(1, 'Prefeitura Municipal de Sabará', '22886816000105', 'Glaison', '(31) 3672-7688', '(31) 2121-2223', 'sabara.mg.gov.br', 'suporte@sabara.mg.gov.br', 'manutencao@sabara.mg.gov.br', '', 'glaison26.queiroz@gmail.com', 'smtp.gmail.com', 'qypq xjmy xmmu uoso', '465');
...
-- Copiando dados para a tabela gop.contratos: ~3 rows (aproximadamente)
INSERT INTO `contratos` (`id`, `id_espacofisico`, `id_setor`, `id_centrocusto`, `empresa`, `tipo_empresa`, `vigencia`, `inicio_contrato`, `termino_contrato`, `numero_contrato`, `resp_contratado`, `resp_contratante`, `periodo_faturamento`, `objeto`, `email_operacional`, `email_diretoria`, `email_gerente`, `valor_mensal`, `dados_iniciais`, `denuncia`, `reajuste`, `tipo_prestador_servico`, `tipo_fornecedor_produtos`, `tipo_producao_mes`, `observacao`) VALUES
	(2, 6, 5, 5, 'Selbetti', 'Locação de Impressoras', '3666 dias', '2025-06-13', '2025-06-30', '3432421', '', '', NULL, 'Localção', '', '', '', 300, 'teste', '', 0, '', '', '', _binary ''),
	(3, 6, 5, 5, 'Cemig', 'Fornecimento de Energia Elétrica', '1300 dias', '2025-06-13', '2032-01-13', '84397848', 'Maria de Lourdes', 'Eugenio da Silva', NULL, 'Energia Elétrica', 'teste@gmail.com', 'teste@gmail.com', 'teste@gmail.com', 1200, 'Empresa Publica Estadual de Energia', 'Diretoria técnica', 5, '', '', '', _binary '');
...
-- Copiando dados para a tabela gop.contratos_lancamentos: ~2 rows (aproximadamente)
INSERT INTO `contratos_lancamentos` (`id`, `id_parametro`, `data`, `quantidade`, `valor`, `nota`, `emissao`, `vencimento`, `cond_pagamento`, `rateio`, `unidade`) VALUES
	(1, 1, '2025-06-23', 1, 250.3, '23442', '2025-06-01', '2025-06-30', '', 'N', 'Real'),
	(2, 1, '2025-06-23', 1, 5000, '999883', '2025-06-03', '2025-06-29', 'A vista', 'N', 'Real'),
	(3, 1, '2025-07-21', 1, 1000, '23477', '2025-07-21', '2025-08-21', '', 'N', 'Real');
...
INSERT INTO `contratos_parametros` (`id`, `id_contrato`, `descricao`, `unidade`) VALUES
	(1, 3, 'Contas de Luz', 'Quilowatt-hora (kWh)'),
	(4, 3, 'teste', 'Quilowatt-hora (kWh)');

-- Copiando estrutura para tabela gop.contratos_rateio
CREATE TABLE IF NOT EXISTS `contratos_rateio` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_centrodecusto` int DEFAULT NULL,
  `valor_rateio` double DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_contratos_rateio_centrodecusto` (`id_centrodecusto`),
  CONSTRAINT `FK_contratos_rateio_centrodecusto` FOREIGN KEY (`id_centrodecusto`) REFERENCES `centrodecusto` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela gop.contratos_rateio: ~0 rows (aproximadamente)
...
INSERT INTO `espacos` (`id`, `descricao`, `tipo`, `medida`, `endereco`, `bairro`, `cidade`, `cep`, `responsavel`, `email`, `fone1`, `fone2`) VALUES
	(6, 'Espaco Fisico de teste', 'Instalação', '', 'Rua da Intendencia 316', 'Centro', 'Sabará', '34505480', 'Glaison', 'suporte@sabara.mg.gov.br', '', '');
...
INSERT INTO `executores` (`id`, `id_oficina`, `id_funcao`, `nome`, `endereco`, `bairro`, `cep`, `cidade`, `uf`, `contato`, `tipo`, `cpf_cnpj`, `email`, `url`, `fone1`, `fone2`, `fone3`, `salario`, `horastrab`, `valorhora`, `escolaridade`, `formacao`, `obs`) VALUES
	(7, 1, 7, 'Glaison Queiroz', 'Rua da Intendencia 316', 'Centro', '34505480', 'Sabará', 'MG', '', 'F', '695.510.226-53', 'glaison26.queiroz@gmail.com', '', '(31) 98426-2508', '', '', 5000, 8, 90, 'Curso Superior', 'Programador', _binary '');
...
-- Copiando dados para a tabela gop.marcas: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela gop.oficinas: ~0 rows (aproximadamente)
...
INSERT INTO `ordens` (`id`, `id_solicitante`, `id_responsavel`, `id_setor`, `id_recurso`, `id_espaco`, `id_oficina`, `data_entrada`, `id_executor_responsavel`, `hora_entrada`, `data_inicio`, `hora_inicio`, `data_conclusao`, `hora_conclusao`, `data_garantia`, `data_entrega`, `hora_entrega`, `data_saida`, `previsao_Horas`, `previsao_minutos`, `tipo`, `numero_nota`, `conclusao`, `valor_material`, `valor_servico`, `tipo_ordem`, `tipo_corretiva`, `tipo_preventiva`, `descritivo`, `mau_uso`, `situacao`, `motivo_naoconformidade`, `data_emissao`, `descricao`, `data_geracao`, `hora_geracao`, `data_previsao`, `hora_previsao`, `status`, `id_solicitacao`, `id_ocorrencia`, `data_cancelamento`, `motivo_cancelamen`, `hora_cancelamento`, `id_resp_cancelamento`) VALUES
	(2, 22, 16, 5, 0, 0, 1, NULL, 7, NULL, '2026-01-14', '10:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'V', NULL, NULL, NULL, NULL, 'C', 'P', NULL, 'Solicitação para modelo', NULL, NULL, NULL, NULL, _binary 0x6d6f64656c6f206465206162657274757261206465206368616d61646f, '2026-01-14', '10:00:00', '2026-01-15', '15:00:00', 'A', 18, 8, NULL, NULL, NULL, NULL);
...
-- Copiando dados para a tabela gop.solicitacao: ~18 rows (aproximadamente)
INSERT INTO `solicitacao` (`id`, `id_setor`, `id_solicitante`, `id_recursos`, `id_espaco`, `id_ocorrencia`, `data_abertura`, `hora_abertura`, `status`, `tipo`, `descricao`, `classificacao`, `id_ordem`) VALUES
	...
	(18, 5, 22, NULL, NULL, 8, '2025-07-21', '17:02:00', 'E', 'P', _binary 0x6d6f64656c6f206465206162657274757261206465206368616d61646f, 'V', 2),
	(20, 5, 16, NULL, NULL, 8, '2026-01-14', '14:44:00', 'A', 'P', _binary 0x6d6f64656c6f206465206162657274757261206465206368616d61646f, 'V', NULL);
