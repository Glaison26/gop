...
-- Copiando dados para a tabela gop.ordens: ~102 rows (aproximadamente)
...
-- Copiando dados para a tabela gop.ordens_executores: ~73 rows (aproximadamente)
...
-- Copiando dados para a tabela gop.recursos: ~13 rows (aproximadamente)
...
-- Copiando dados para a tabela gop.solicitacao: ~93 rows (aproximadamente)
