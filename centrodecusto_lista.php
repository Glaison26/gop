...
<head>
    ...
    <title>Gop - Lista de Centro de Custo</title>
...
<body>
    ...
    <div class="panel panel-light" style="background-color: #e3f2fd;">
        <div class="panel-heading text-center">
            <h2>Lista de Centro de Custo</h2>
        </div>
    </div>
    ...
    <div class="container -my5">
        ...
        <hr>
        <table class="table display table-hover  table-condensed tabcentrodecusto">
            ...
            <tbody>
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>$c_linha[fone2]</td>
                    <td>
                    <a class='btn btn-info btn-sm' href='/gop/centrodecusto_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
