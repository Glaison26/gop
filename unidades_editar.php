...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {  // metodo get para carregar dados no formulário
    ...
    $c_sql = "select * from unidades where id=$c_id";
    ...
    do {
        if (empty($c_descricao) || empty($c_abrev)) {
        ...
        $c_sql = "Update unidades" .
            " SET descricao = '$c_descricao' , abreviatura = '$c_abrev'" .
            " where id=$c_id";
        echo $c_sql;
        $result = $conection->query($c_sql);
...
<head>
    ...
    <title>Editar Unidade sw Medida</title>
