    ...
    <div class="container -my5">
        ...
        <form method="post">
            ...
            <div class="mb-5 row">
                ...
                <div class="col-md-3">
                    <button class="btn btn btn-sm" type="submit" id='bntpesquisa' name='btnpesquisa' class="btn btn"><img src='\smedweb\images\buscar.png' alt='' width='20' height='20'></span> Buscar</button>
