...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {  // metodo get para carregar dados no formulário
    ...
    if (!isset($_GET["id"])) {
        header('location: /gop/funcoes_lista.php');
        exit;
    }

    $c_id = $_GET["id"];
    // leitura do cliente através de sql usando id passada
    $c_sql = "select * from funcoes where id=$c_id";
    ...
    do {
        if (empty($c_descricao)) {
            $msg_erro = "Campo descrição deve ser preenchidos!!";
            break;
        }
        ...
        $c_sql = "Update funcoes" .
            " SET descricao = '$c_descricao', ValorHora = '$n_valorhora'" .
            " where id=$c_id";
        echo $c_sql;
        $result = $conection->query($c_sql);
...
<body>
    ...
    <div class="container -my5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Valor Hora</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="valorhora" placeholder="formato 0.00" value="<?php echo $n_valorhora; ?>">
                </div>
            </div>
            <?php
            if (!empty($msg_gravou)) {
            ...
            <div class="row mb-3">
                <div class="offset-sm-3 col-sm-3 d-grid">
                    ...
                    <a class='btn btn-danger' href='/gop/funcoes_lista.php'><span class='glyphicon glyphicon-remove'></span> Cancelar</a>
                </div>
