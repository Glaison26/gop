...
<head>
    ...
    <title>Gop - Lista de Ferramentas</title>
        ...
        <table class="table display table-hover  table-condensed tabferramentas">
            ...
            <tbody>
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>$c_linha[serie]</td>
                    <td>
                    <a class='btn btn-info btn-sm' href='/gop/ferramentas_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
