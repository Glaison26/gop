...
<head>
    ...
    <title>Gop - Lista de Espaços Fisicos</title>
...
<body>
    ...
    <div class="panel panel-light" style="background-color: #e3f2fd;">
        <div class="panel-heading text-center">
            <h2>Lista de Espaços Fisicos</h2>
        </div>
    </div>
    ...
    <div class="container -my5">
        ...
        <hr>
        <table class="table display table-hover  table-condensed tabespacos">
            ...
            <tbody>
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>$c_linha[fone2]</td>
                    <td>
                    <a class='btn btn-info btn-sm' href='/gop/espacos_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span> Editar</a>
