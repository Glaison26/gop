...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    do {
        ...
        $c_hora_conclusao = $_POST['hora_suspensao'];
        ...
        $c_sql = "insert into ordens_suspensao (id_ordem,data_suspensao,hora_suspensao,motivo) value ('$i_id','$c_data_suspensao', '$c_hora_conclusao', '$c_motivo')";
        $result = $conection->query($c_sql);
