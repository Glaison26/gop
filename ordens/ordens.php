...
if ((isset($_POST["btnpesquisa"])) && ($_SERVER['REQUEST_METHOD'] == 'POST')) {
    ...
    // sql para ocorrência 
    if ($_POST['ocorrencia'] <> "Todos") {
        $c_ocorrencia = $_POST['ocorrencia'];
        $c_sql_ocorrencia = "select ocorrencias.id, ocorrencias.descricao from ocorrencias where ocorrencias.descricao = '$c_ocorrencia'";
                    ...
                    <div class="row mb-3">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-2">
                                        <label class="radio-label">
                                            <input type="radio" value="A" name="rdo_data" id="rdo_data" checked> Abertura
                                        </label>
                        ...
                        ";
                            ...
                            <div class="row mb-3">
                                ...
                                <label class="col-sm-1 col-form-label">Ocorrência</label>
                                <div class="col-sm-4">
