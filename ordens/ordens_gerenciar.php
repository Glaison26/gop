                ...
                <div style="padding-bottom :2px;">
                    <div class="topnav">
                        ...
                        if ($c_linha_ordem['status'] <> 'C' && $c_linha_ordem['status'] <> 'S' && $c_linha_ordem['status'] <> 'X') {
                            echo "<a title='Editar Ordem de serviço' href='\gop\ordens\ordens_editar.php?id=<?php echo $i_id ?>'><img src='\gop\images\xxxescrita.png' alt='' width='30' height='25'><span> Editar</span></a>
