...
<body>
    ...
    <div class="container-fluid">
        ...
        <hr>
        <table class="table table-bordered table-striped tabartigos">
            <thead class="thead">
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
                ...
                $c_sql = "SELECT artigos.id, artigos.titulo, artigos.tags, artigos_categoria.descricao AS categoria
                        FROM artigos 
                        JOIN artigos_categoria ON artigos.id_categoria=artigos_categoria.id
                        ORDER BY artigos.titulo";
